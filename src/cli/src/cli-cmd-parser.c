                       ...
                       struct cli_state *state)
{
        ...
        if (strcmp(words[cmdi], "auto-delete") == 0) {
                ...
                if (vol_presence == 1) {
                        ret = -1;
                        cli_err ("As of now, activate-on-create option cannot "
                                 "be set to volumes");
                        gf_log ("cli", GF_LOG_ERROR, "activate-on-create option"
                                " cannot be set to volumes");
                        goto out;
                }
                ...
                if ((strcmp (words[cmdi], "enable") == 0) ||
                    (strcmp (words[cmdi], "disable") == 0)) {
                        ...
                        if (ret) {
                                gf_log ("cli", GF_LOG_ERROR, "Failed to set "
                                        "value of activate-on-create in request"
                                        " dictionary");
                                goto out;
                        }
                } else {
