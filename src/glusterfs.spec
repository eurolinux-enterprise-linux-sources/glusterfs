...
%changelog
* Wed Feb 18 2015 Atin Mukherjee <amukherj@redhat.com>
- .cmd_log_history file should be renamed to cmd_history.log post upgrade
  (#181051)

* Tue Dec 16 2014 Aravinda VK <avishwan@redhat.com>
- Moved stop-all-gluster-processes.sh in glusterfs-server section.

* Thu Nov 13 2014 Aravinda VK <avishwan@redhat.com>
- Added a extras script stop-all-gluster-processes.sh
