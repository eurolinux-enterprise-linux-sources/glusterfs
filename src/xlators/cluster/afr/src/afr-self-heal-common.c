...
afr_self_heal_inodelk_init (afr_local_t *local, xlator_t *this)
{
        ...
        if (pos >= AFR_DOM_COUNT_MAX) {
                //This is more like data representation check.
                //Process may crash if this happens. AFR_DOM_COUNT_MAX should
                //always be 1 more than the number of different domains afr
                //takes locks in.
                ret = -ENOMEM;
        }
out:
